...
public class MyAdapter extends BaseAdapter {
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
        ...
        ItemHandler handler=null;
        	...
        	handler.contactName = (TextView) arg1.findViewById(R.id.textView1);
        	handler.contactNumber = (TextView) arg1.findViewById(R.id.textView2);
        	arg1.setTag(handler);
      
        handler.contactName.setText(list.get(arg0).getContactName());
        handler.contactNumber.setText(list.get(arg0).getContactNumber());
		return arg1;
	}
